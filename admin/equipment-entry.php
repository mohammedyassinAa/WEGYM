    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    Home</a> <a href="#" class="tip-bottom">Equipments</a> <a href="#" class="current">Add
                    Equipments</a> </div>
                        ...
                        <div class="widget-content nopadding">
                            <form action="add-equipment-req.php" method="POST" class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span11" name="ename" placeholder="Equipment Name"
                                            required />
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" class="span5" name="quantity" placeholder="Equipment Qty"
                                            required />
                                    </div>
                                </div>
                        ...
                        <div class="widget-content nopadding">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span11" name="address" placeholder="Vendor Address"
                                            required />
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-append">
                                                ...
                                                <input type="number" placeholder="269" name="amount" class="span11"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
