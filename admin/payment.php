                ...
                <div class="span12">
                    ...
                    <div class='widget-box'>
                        <div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
                            ...
                            <form id="custom-search-form" role="search" method="POST" action="search-result.php"
                            ...
                            <tbody>
                                ...
                                <td>
                                    <div class='text-center'>
                                        <?php echo($row['paid_date'] == 0 ? "New Member" : $row['paid_date'])?></div>
                                </td>
                                ...
                                <td>
                                    <div class='text-center'><a
                                            href='user-payment.php?id=<?php echo $row['user_id']?>'><button
                                                class='btn btn-success btn'><i class='fas fa-dollar-sign'></i> Make
