    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    Home</a> <a href="progress-report.php" class="current">Progress Reports</a> </div>
                            ...
                            <tbody>
                                ...
                                <td>
                                    <div class='text-center'><a
                                            href="view-progress-report.php?id= <?php echo $row['user_id'] ?>"><i
                                                class="fas fa-file"></i> View Progress Report</a></div>
                                </td>
