                                ...
                                <div class="span5">
                                    <table class="">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Avenue Berkane Street n 12, Tetouan</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>Email: WEGYM2024@gmailcom</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                            ...
                                            <form action="userpay.php" method="POST">
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="services"
                                                        value="<?php echo $row['services']; ?>">
                                                    <td><strong><?php echo $row['services']; ?></strong></td>
                                                </tr>
                                                <tr>
                                                    <td>Amount Per Month:</td>
                                                    <td><input id="amount" type="number" name="amount"
                                                            value='<?php if($row['services'] == 'Fitness') { echo '55';} elseif ($row['services'] == 'Sauna') { echo '35';} else {echo '40';} ?>' />
                                                    </td>
                                                </tr>

                                                <input type="hidden" name="paid_date"
                                                    value="<?php echo $row['paid_date']; ?>">
