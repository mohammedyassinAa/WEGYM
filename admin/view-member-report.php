    ...
    <div id="content">
        ...
        <div class="container-fluid print-container">
            ...
            ?>
                                ...
                                <div class="span4">
                                    <table class="">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Avenue Berknane Tetouan</td>
                                            </tr>

                                            <tr>
                                                <td>Tel: +212 6 10 58 06 25 </td>
                                            </tr>
                                            <tr>
                                                <td>Email: WEGYM@gmail.com</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <?php if($row['plan'] == 0) { echo 'NONE';} else {echo $row['plan'].' Month/s';} ?>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="text-center"><?php echo $row['attendance_count']; ?>
                                                        Day/s</div>
                                                </td>
                                            </tr>
                                        </tbody>
                                            ...
                                            <tr>
                                                <td class="msg-invoice" width="55%">
                                                    <div class="text-center">
                                                        ...
                                                        <em><a href="#" class="tip-bottom" title="Registration Date"
                                                                style="font-size:15px;">Member Since:
                        ...
                        <div class="row-fluid">
                            <div class="pull-left">
                                <h4>Member <?php echo $row['fullname']; ?>,<br />
                                    <br /> Membership is currently
